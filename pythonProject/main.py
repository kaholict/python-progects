...
nextt = input()
while nextt.lower() != 'далее':
    nextt = input('Чтобы продолжить, введи "Далее"')

print("да / нет")
nextt = input()
while nextt.lower() != 'готов' and nextt.lower() != 'готова' and nextt.lower() != 'да':
    nextt = input('Чтобы продолжить, введи "Да" или "Готов"')
